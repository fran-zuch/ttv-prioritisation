...
# ==========================================================
# 1. Dynamic percentile-based interpretation
# ==========================================================
def add_dynamic_interpretation(df):
    df = df.copy()

    # --- Percentiles ---
    for col in ['obs_frac', 'final_score']:
    ...
    def interpret_obs(r):
        ...
        if pd.isna(p):
            ...
            return "excellent visibility (top 20%)"
        elif p > 0.5:
    ...
    def interpret_ephemeris(r):
        ...
        if t > 3000:
            return "ephemeris likely degraded"
        elif t > 1000:
            return "ephemeris uncertainty increasing"
        elif t > 100:
            return "moderately recent observations"
        else:
    ...
    def interpret_score(r):
        ...
        if pd.isna(p):
            ...
            return "top priority target"
        elif p > 0.6:
            return "high priority target"
        elif p > 0.4:
            return "moderate priority target"
        else:
...
# ==========================================================
# 2. Synergy explanation (network + campaign)
# ==========================================================
...
# ==========================================================
# 3. Human-readable recency label
# ==========================================================
...
# ==========================================================
# 4. Score breakdown panel (for dashboard)
# ==========================================================
def build_score_breakdown(df):
    ...
    def panel(r):
        return {
            ...
            "score": round(r.get('final_score', 0), 2),
            "visibility": r.get('obs_interpretation'),
            "ephemeris": r.get('ephemeris_interpretation'),
            "last_observation": r.get('recency_text'),
            "coordination": r.get('synergy_explanation'),
            "network_flag": bool(r.get('network_needed')),
            "campaign_flag": bool(r.get('campaign_flag')),
